...
{{--     <!-- ======= Skills Section ======= -->
    ...
    <section id="resume" class="resume">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3 class="resume-title">Coordenadora</h3>
            <div class="resume-item pb-0">
              ...
              <ul>
                ...
                <li>(123) 456-7891</li>
                <li>alicia.maria@example.com</li>
              </ul>
            </div>

            <h3 class="resume-title">Estagiários</h3>
  ...
  <footer id="footer">
    <div class="container">
      ...
      <a href="#" target="_blank">Créditos e Licensas de uso</a>
  {{-- <div class="credits">
